...
https://github.com/grigoriev/alfred-mvns-workflow/security/advisories/new
...
Vulnerabilities in upstream software (Alfred, the Maven Central search API, `jq`) belong to the upstream project. Tell us as well
